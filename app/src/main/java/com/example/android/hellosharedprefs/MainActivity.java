...
//        }
        ...
        mShowCountTextView.setText(String.format("%s", mCount)); //update value of main TextView with the new count
        mColor = mPreferences.getInt(COLOR_KEY, mColor); //get color from the preferences with the COLOR_KEY key and assign it to mC
        mShowCountTextView.setBackgroundColor(mColor);
    }
